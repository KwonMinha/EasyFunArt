 ...
 */
class Home2ThirdAdapter(var context : Context, var dataList : ArrayList<HomeTheme3>?, var requestManager: RequestManager) : RecyclerView.Adapter<Home2ViewHolder>() {
    private var onItemClick : View.OnClickListener? = null

    private var networkService: NetworkService? = null
    private var TAG = "Home_Recycler3_Like"
