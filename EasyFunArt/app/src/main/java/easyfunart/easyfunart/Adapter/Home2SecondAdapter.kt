 ...
 */
class Home2SecondAdapter (var context : Context, var dataList : ArrayList<HomeTheme2>?, var requestManager: RequestManager) : RecyclerView.Adapter<Home2ViewHolder>() {
    private var onItemClick : View.OnClickListener? = null

    private var networkService: NetworkService? = null
    private var TAG = "LOG::Home_Recycler2_Like"
