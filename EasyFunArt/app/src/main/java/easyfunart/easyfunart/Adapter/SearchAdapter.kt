 ...
 */
class SearchAdapter (var context: Context, var dataList: ArrayList<SearchData>?, var requestManager: RequestManager) : RecyclerView.Adapter<Home2ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: Home2ViewHolder?, position: Int) {
        ...
        holder.homeSecondDocent.setOnClickListener {
            ...
            view.dialog_docent_image.setImageResource(R.drawable.poster)
